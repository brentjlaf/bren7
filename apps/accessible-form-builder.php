...
<head>
  ...
  <style>
    ...
    .btn-bren7-green:hover {
      background-color: #008e7f;
      border-color: #008e7f;
      color: #ffffff;
    }
    .btn-outline-bren7-green {
      color: var(--bs-primary);
      border-color: var(--bs-primary);
      font-weight: 600;
      padding: 6px 12px;
...
<body class="app-page">
  ...
  <div class="container position-relative">
    ...
    <div class="d-flex align-items-center mb-3 flex-wrap justify-content-between" style="gap: 15px;">
      ...
      <div class="d-flex align-items-center flex-wrap" style="gap: 8px;">
        <div class="d-flex align-items-center">
          ...
          <button id="load-prebuilt" class="btn btn-outline-bren7-green">Load</button>
        </div>
      </div>
    ...
    <div class="d-flex justify-content-end mt-3" style="gap: 8px;">
      <button class="btn btn-bren7-green" id="generate-btn">Generate Form</button>
      ...
      <div class="modal-content">
        <form id="form-settings-form">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-bren7-green">Save Settings</button>
          </div>
        </form>
      </div>
    </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <form id="config-form">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
            <button type="submit" class="btn btn-bren7-green">Save Field</button>
          </div>
        </form>
      </div>
    </div>
